...
const ProductModal = ({ isOpen, onClose, selectedProduct, imagePreviews }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md z-10 animate-neonTable">
                <h2 className="text-xl font-bold mb-4">Product Details</h2>
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <p><strong>ProductType ID:</strong> {selectedProduct.prodTypeId?.prodTypeId || "N/A"}</p>
                        <p>
                            <strong>Belong Product:</strong>{" "}
                            {selectedProduct.prodTypeId?.prodId?.prodName || "N/A"} -{" "}
                            <span
                                className={
                    ...
                    <div className="space-y-2">
                        <p><strong>Description:</strong> {selectedProduct.prodTypeId?.prodId?.description || "N/A"}</p>
